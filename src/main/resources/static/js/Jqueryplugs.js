...
$.extend({
    ...
    /*遮罩阴影层*/
    jq_MaskDiv: function () {
        var str = "<div aria-hidden='false' class='theme-popover-mask' style=\"z-index:1;position:fixed;left:0;top:0;right:0;background:#000;opacity:0.1;filter:alpha(opacity=10);-moz-opacity:0.1;display:none;\"></div>";
        $("body").append(str);
    ...
    jq_Confirm: function (e) {
        ...
        var str = "<div class='jq_dvconfirm' style='z-index:2;box-shadow: 0 0 5px #BCD4E5;position:absolute;background-Color:#fff;min-width:578px;width:578px;min-height:144px;border: 1px solid rgba(0, 0, 0, 0.2);font-size: 13px;opacity:0;filter:alpha(opacity=0);-moz-opacity:0;'>"
                        + "<div style='min-height:54px;line-height:54px;padding:20px;'>"
                                + "<button title='关闭' class='btncloseconfirm' style='outline:0;float:right;margin-top:-20px;font-size:18px;font-weight: bold;color: rgb(0, 0, 0);text-shadow: 0px 1px 0px rgb(255, 255, 255);border:0px;background-color:transparent;cursor:pointer;opacity:0.2;filter:alpha(opacity=20);-moz-opacity:0.2;'>×</button>"
    ...
    jq_Alert: function (e) {
        ...
        var str = "<div class='jq_dvalert' style='z-index:2;box-shadow: 0 0 5px #BCD4E5;position:absolute;background-Color:#fff;min-width:578px;width:578px;min-height:144px;border: 1px solid rgba(0, 0, 0, 0.2);font-size: 13px;opacity:0;filter:alpha(opacity=0);-moz-opacity:0;'>"
                        + "<div style='min-height:54px;line-height:54px;padding:20px;'>"
                                + "<button title='关闭' class='btnclosealert' style='outline:0;float:right;margin-top:-10px;font-size:18px;font-weight: bold;color: rgb(0, 0, 0);text-shadow: 0px 1px 0px rgb(255, 255, 255);border:0px;background-color:transparent;cursor:pointer;opacity:0.2;filter:alpha(opacity=20);-moz-opacity:0.2;'>×</button>"
                                + "<div style='font-size:16px;color: rgb(57, 57, 57);'>" + e.message + "</div>"
                        + "</div>"
                        + "<div style='overflow:auto;padding:12px 14px;background-color:rgb(239, 243, 248);'>"
    ...
    jq_Loading: function () {
        //set it's modal
        $.jq_MaskDiv();
        var str = "<div class='jq_dvloading' style='z-index:2;box-shadow: 0 0 5px #BCD4E5;position:absolute;background-Color:#fff;min-width:578px;width:578px;border: 1px solid rgba(0, 0, 0, 0.2);font-size: 13px;opacity:0;filter:alpha(opacity=0);-moz-opacity:0;'>"
                        + "<div style='height:100px;padding:30px 30px;'>"
                                + "<div style='font-weight:bold;height:100px;line-height:100px;text-indent:160px;font-size:16px;color: rgb(57, 57, 57);background-Image:url('/images/loading.gif');background-repeat:no-repeat;background-position:40px 0px;'>正在加载，请稍后……</div>"
                        + "</div>"
                    + "</div>";
        $("body").append(str);
    ...
    jq_Notifation: function (e) {
        ...
        var str = "<div class='jq_dvnotifation' style='z-index:2;box-shadow: 0 0 5px #BCD4E5;position:absolute;right:5px;bottom:3px;background-Color:#fff;min-width:328px;width:328px;border: 1px solid rgba(0, 0, 0, 0.2);font-size: 13px;opacity:0;filter:alpha(opacity=0);-moz-opacity:0;'>"
                        + "<div class='jq_dvnotifation_title' style='background-color:#ECF2F7 !important;border-bottom: 1px solid #BCD4E5 !important;font-weight:600;padding:10px 10px;'>"
                                + "提示消息"
                                + "<button title='关闭' class='btnclosenotifation' style='outline:0;float:right;margin-top:-5px;font-size:18px;font-weight: bold;color: rgb(0, 0, 0);text-shadow: 0px 1px 0px rgb(255, 255, 255);border:0px;background-color:transparent;cursor:pointer;opacity:0.2;filter:alpha(opacity=20);-moz-opacity:0.2;'>×</button>"
                        + "</div>"
